  ...
  return (
    <div className="bg-white border border-line rounded-xl p-6 flex flex-col gap-4">
      <div className="flex flex-col gap-1">
        <label htmlFor="signed-name" className="text-ink text-sm font-medium">
      ...
      <button
        ...
        className="w-full py-2.5 px-6 bg-wine text-paper font-semibold text-sm rounded-lg transition-opacity disabled:opacity-40 disabled:cursor-not-allowed hover:opacity-90"
      >
